...
| [`12-combat-resolution`](12-combat-resolution/README.md) | G | MH | **Open** (B0–B4 done; B5–B7) | Damage resolves on both sides — towers kill, walls break into rubble, bodies pile — and an undefended base falls on a measurable clock |
