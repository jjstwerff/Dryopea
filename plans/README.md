...
| [`13-the-vehicle`](13-the-vehicle/README.md) | G | MH | **Active** (V0-V1 done; V2-V4) | A player in the world — the crew plan 12 measured a need for.  V1 drives; V2 clears the bodies that beat the tower |
