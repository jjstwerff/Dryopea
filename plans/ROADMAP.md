...
| Combat resolves (damage, death, rubble, towers) | **in progress** | [plan 12](12-combat-resolution/README.md) | B0-B5b shipped: walls have structural HP and break into climbable rubble, enemies have HP and die leaving bodies that ramp a kill zone shut, and towers fire at 15 hex with a sight line and a 30-shot budget.  Left: B6 (nibble drains the wallet), B7 (the headline gate — an authored base with walls and towers, nobody defending it, falling on a clock that is markedly longer for having the defences) |
