...
extern crate dryopea;"
    ...
    /// Use this to emit `OpFormatText` as a call to `external::format_text`.
    ...
    /// Use this to emit `OpFormatLong` as a call to `external::format_long`.
