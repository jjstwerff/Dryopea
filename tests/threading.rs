...
use dryopea::parallel::{WorkerProgram, run_parallel_int};
...
fn compile(code: &str) -> (State, dryopea::data::Data) {
...
"#;
    ...
    let input = DbRef { store_nr: db.store_nr, rec: header_rec, pos: 4 };
...
use dryopea::parallel::run_parallel_raw;
...
"#;
    ...
    assert_eq!(longs, vec![1_000_000_000i64, 2_000_000_000, 3_000_000_000], "long results");
}
...
"#;
    ...
    assert_eq!(bools, vec![true, false, true, false, true], "even/odd booleans");
}
