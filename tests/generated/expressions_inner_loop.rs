...
fn n_test(stores: &mut Stores) { //block_1: void
          ...
          { //For block_7: void
            ...
            loop { //For loop_8
              ...
              { //block_10: void
                ...
                let _pre0 = { //Formatted string_12: text["__work_1"]
                  var___work_1 = "".to_string();
                  external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var_i))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
                  external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var_j))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
                  (var___work_1).push_str(&(",".to_string()));
                  var___work_1
                } /*Formatted string_12: text["__work_1"]*/;
                (var_s).push_str(&(_pre0));
                if (100_i32) < (t_4text_len(stores, var_s.clone())) { //block_13: void
                  break;
                } /*block_13: void*/ else {()};
              } /*block_10: void*/;
            } /*For loop_8*/;
  ...
  if (var_test_value) == ("00,10,11,20,21,22,30,31,32,33,40,41,42,43,44,50,51,52,53,54,55,60,61,62,63,64,65,66,70,71,72,73,74,75,".to_string()) {()} else {panic!("{}", ({ //Formatted string_14: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"00,10,11,20,21,22,30,31,32,33,40,41,42,43,44,50,51,52,53,54,55,60,61,62,63,64,65,66,70,71,72,73,74,75,\"".to_string()));
      var___work_2
