  ...
  let mut var_test_value = String::new();
    ...
    { //Formatted string_3: text["__work_1"]
      ...
      loop { //Append Iter_4
        ...
        external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var__val_1))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      } /*Append Iter_4*/;
      (var___work_1).push_str(&("]".to_string()));
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  if (var_test_value) == ("[3,12,18]".to_string()) {()} else {panic!("{}", ({ //Formatted string_10: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"[3,12,18]\"".to_string()));
      var___work_2
