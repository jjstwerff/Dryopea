...
fn n_to_text(stores: &mut Stores, mut var___work_1: DbRef) -> String {
  todo!()
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    { //Formatted string_3: text["__work_1"]
      ...
      let _pre0 = { //default ref_4: ref(reference)["__work_2"]
        todo!()
      } /*default ref_4: ref(reference)["__work_2"]*/;
      external::format_text(&mut (var___work_1), &(n_to_text(stores, _pre0)), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_1).push_str(&("2".to_string()));
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("1aa bb cc2".to_string()) {()} else {panic!("{}", ({ //Formatted string_5: text["__work_3"]
      var___work_3 = "Test failed ".to_string();
      external::format_text(&mut (var___work_3), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_3).push_str(&(" != \"1aa bb cc2\"".to_string()));
      var___work_3
