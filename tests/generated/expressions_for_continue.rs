...
fn n_test(stores: &mut Stores) { //block_1: void
  let mut var___work_1: String = "".to_string();
  let mut var_t: String = "".to_string();
  let mut var_test_value = String::new();
    var_test_value = { //block_2: text["t"]
    var_t = "".to_string();
    { //For block_3: void
      ...
      loop { //For loop_4
        let mut var_a: i32 = { //Iter range_5: integer
          ...
          if (30_i32) <= (var_a__index) {break} else {()};
          var_a__index
        } /*Iter range_5: integer*/;
        { //block_6: void
          let mut var_v: String = "a ".to_string();
          if (2_i32) < (var_a) { //block_7: void
            {};
            continue;
          } /*block_7: void*/ else {()};
          (var_t).push_str(&(var_v));
          {};
        } /*block_6: void*/;
      } /*For loop_4*/;
    } /*For block_3: void*/;
