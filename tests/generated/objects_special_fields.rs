...
fn n_sum(stores: &mut Stores, mut var_o: DbRef) -> i32 { //block_1: integer
  ...
  ;
  { //For block_2: void
    let mut var__vector_1: DbRef = DbRef {store_nr: (var_o).store_nr, rec: (var_o).rec, pos: (var_o).pos + (0_i32) as u32};
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    (var_o) = stores.alloc_record((20_i32) as u16);
    {let db = (var_o); let _val = (0_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    let mut var__elm_1: DbRef = stores.record_new(&(var_o), (20_i32) as u16, (0_i32) as u16);
    {let db = (var__elm_1); let _val = (1_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    stores.record_finish(&(var_o), &(var__elm_1), (20_i32) as u16, (0_i32) as u16);
    var__elm_1 = stores.record_new(&(var_o), (20_i32) as u16, (0_i32) as u16);
    ...
    stores.record_finish(&(var_o), &(var__elm_1), (20_i32) as u16, (0_i32) as u16);
    {let db = (var_o); let _val = i32::from((3_u8)); stores.store_mut(&db).set_byte(db.rec, db.pos + (4_i32) as u32, 0, _val);};
    ;
    let mut var__elm_2: DbRef = stores.record_new(&(var_o), (20_i32) as u16, (0_i32) as u16);
    let _pre0 = n_sum(stores, var_o);
    {let db = (var__elm_2); let _val = (_pre0); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    stores.record_finish(&(var_o), &(var__elm_2), (20_i32) as u16, (0_i32) as u16);
    ;
    { //Formatted string_3: text["__work_1"]
      var___work_1 = "".to_string();
      (var___work_1).push_str(&stores.rec(&(var_o), (20_i32) as u16));
      drop((var_o));
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("{a:[1,4,3,8],b:Fluid}".to_string()) {()} else {panic!("{}", ({ //Formatted string_4: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"{a:[1,4,3,8],b:Fluid}\"".to_string()));
      var___work_2
