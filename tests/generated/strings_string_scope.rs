...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    { //For block_3: void
      ...
      loop { //For loop_4
        ...
        { //block_6: void
          ...
          ;
          (var_b).push_str(&("n".to_string()));
          let _pre0 = { //Formatted string_7: text["__work_1"]
            var___work_1 = ":".to_string();
            external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var_n))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
            var___work_1
          } /*Formatted string_7: text["__work_1"]*/;
          (var_b).push_str(&(_pre0));
          (var_b).push_str(&("=".to_string()));
          ;
          { //For block_8: void
            ...
            loop { //For loop_9
              ...
              { //block_11: void
                ;
                (var_t).push_str(&("2".to_string()));
              } /*block_11: void*/;
            } /*For loop_9*/;
          } /*For block_8: void*/;
          ;
          (var_b).push_str(&(var_t));
          (var_b).push_str(&(" ".to_string()));
          ;
    ...
    { //Formatted string_12: text["__work_2"]
      ...
      external::format_long(&mut (var___work_2), (var_a), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_2).push_str(&(" via ".to_string()));
      external::format_text(&mut (var___work_2), &(var_b), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      {};
      var___work_2
    } /*Formatted string_12: text["__work_2"]*/.to_string()
  } /*block_2: text["__work_2"]*/;
  ;
  if (var_test_value) == ("136 via n:1=1 n:2=12 n:3=122 ".to_string()) {()} else {panic!("{}", ({ //Formatted string_13: text["__work_3"]
      var___work_3 = "Test failed ".to_string();
      external::format_text(&mut (var___work_3), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_3).push_str(&(" != \"136 via n:1=1 n:2=12 n:3=122 \"".to_string()));
      var___work_3
