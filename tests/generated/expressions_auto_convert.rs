...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i64 = { //block_2: long
    external::op_mul_long((10_i64), (external::op_conv_long_from_int((2_i32))))
  } /*block_2: long*/;
  ;
  if (var_test_value) == (20_i64) {()} else {panic!("{}", ({ //Formatted string_3: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 20l".to_string()));
      var___work_1
