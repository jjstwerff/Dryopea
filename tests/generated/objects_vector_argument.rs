...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    let _pre1 = { //Vector_3: vector<integer>
      (var___ref_1) = stores.alloc_record((19_i32) as u16);
      let mut var__vec_1: DbRef = DbRef {store_nr: (var___ref_1).store_nr, rec: (var___ref_1).rec, pos: (var___ref_1).pos + (0_i32) as u32};
      {let db = (var___ref_1); let _val = (0_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
      let mut var__elm_2: DbRef = stores.record_new(&(var__vec_1), (18_i32) as u16, (65535_i32) as u16);
      {let db = (var__elm_2); let _val = (1_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
      stores.record_finish(&(var__vec_1), &(var__elm_2), (18_i32) as u16, (65535_i32) as u16);
      var__elm_2 = stores.record_new(&(var__vec_1), (18_i32) as u16, (65535_i32) as u16);
      ...
      stores.record_finish(&(var__vec_1), &(var__elm_2), (18_i32) as u16, (65535_i32) as u16);
      var__elm_2 = stores.record_new(&(var__vec_1), (18_i32) as u16, (65535_i32) as u16);
      {let db = (var__elm_2); let _val = (5_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
      stores.record_finish(&(var__vec_1), &(var__elm_2), (18_i32) as u16, (65535_i32) as u16);
      var__vec_1
    } /*Vector_3: vector<integer>*/;
    let _pre0 = n_sum(stores, _pre1);
    let _pre3 = { //Append Vector_4: vector<integer>["__ref_4"]
      (var___ref_4) = stores.alloc_record((19_i32) as u16);
      let mut var__vec_7: DbRef = DbRef {store_nr: (var___ref_4).store_nr, rec: (var___ref_4).rec, pos: (var___ref_4).pos + (0_i32) as u32};
      {let db = (var___ref_4); let _val = (0_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
      let _pre0 = { //Vector_5: vector<integer>
        (var___ref_2) = stores.alloc_record((19_i32) as u16);
        let mut var__vec_3: DbRef = DbRef {store_nr: (var___ref_2).store_nr, rec: (var___ref_2).rec, pos: (var___ref_2).pos + (0_i32) as u32};
        {let db = (var___ref_2); let _val = (0_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
        let mut var__elm_4: DbRef = stores.record_new(&(var__vec_3), (18_i32) as u16, (65535_i32) as u16);
        {let db = (var__elm_4); let _val = (1_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
        stores.record_finish(&(var__vec_3), &(var__elm_4), (18_i32) as u16, (65535_i32) as u16);
        var__elm_4 = stores.record_new(&(var__vec_3), (18_i32) as u16, (65535_i32) as u16);
        {let db = (var__elm_4); let _val = (2_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
        stores.record_finish(&(var__vec_3), &(var__elm_4), (18_i32) as u16, (65535_i32) as u16);
        var__elm_4 = stores.record_new(&(var__vec_3), (18_i32) as u16, (65535_i32) as u16);
        {let db = (var__elm_4); let _val = (3_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
        stores.record_finish(&(var__vec_3), &(var__elm_4), (18_i32) as u16, (65535_i32) as u16);
        var__vec_3
      } /*Vector_5: vector<integer>*/;
      stores.vector_add(&(var__vec_7), &(_pre0), (0_i32) as u16);;
      let _pre1 = { //Vector_6: vector<integer>
        (var___ref_3) = stores.alloc_record((19_i32) as u16);
        let mut var__vec_5: DbRef = DbRef {store_nr: (var___ref_3).store_nr, rec: (var___ref_3).rec, pos: (var___ref_3).pos + (0_i32) as u32};
        {let db = (var___ref_3); let _val = (0_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
        let mut var__elm_6: DbRef = stores.record_new(&(var__vec_5), (18_i32) as u16, (65535_i32) as u16);
        {let db = (var__elm_6); let _val = (4_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
        stores.record_finish(&(var__vec_5), &(var__elm_6), (18_i32) as u16, (65535_i32) as u16);
        var__elm_6 = stores.record_new(&(var__vec_5), (18_i32) as u16, (65535_i32) as u16);
        {let db = (var__elm_6); let _val = (5_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
        stores.record_finish(&(var__vec_5), &(var__elm_6), (18_i32) as u16, (65535_i32) as u16);
        var__vec_5
      } /*Vector_6: vector<integer>*/;
      stores.vector_add(&(var__vec_7), &(_pre1), (0_i32) as u16);;
      var__vec_7
    } /*Append Vector_4: vector<integer>["__ref_4"]*/;
    let _pre2 = external::op_mul_int((100_i32), (n_sum(stores, _pre3)));
    external::op_add_int((_pre0), (_pre2))
  } /*block_2: integer*/;
  ;
  if (var_test_value) == (1515_i32) {()} else {panic!("{}", ({ //Formatted string_7: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 1515".to_string()));
      var___work_1
