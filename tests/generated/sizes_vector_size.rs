...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    ...
    let _ret = external::op_add_int((external::op_add_int((external::op_add_int((12_i32), (external::op_mul_int((100_i32), (4_i32))))), (external::op_mul_int((10000_i32), (OpSizeofRef(stores, var_m)))))), (external::op_mul_int((100000_i32), (12_i32))));
    drop((var_m));
    _ret
  } /*block_2: integer*/;
  if (var_test_value) == (1240412_i32) {()} else {panic!("{}", ({ //Formatted string_3: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 1240412".to_string()));
      var___work_1
