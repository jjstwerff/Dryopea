...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    external::op_logical_and_int((external::op_min_int((external::op_shift_left_int((1_i32), (8_i32))), (3_i32))), (127_i32))
  } /*block_2: integer*/;
  if (var_test_value) == (125_i32) {()} else {panic!("{}", ({ //Formatted string_3: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 125".to_string()));
      var___work_1
