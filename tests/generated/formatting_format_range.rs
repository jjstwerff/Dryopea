...
fn n_test(stores: &mut Stores) { //block_1: void
      ...
      loop { //Append Iter_4
        let mut var__val_1: i32 = { //Iter For_5: integer
          let mut var_x: i32 = { //Iter range_6: integer
            var_x__index = if !(external::op_conv_bool_from_int((var_x__index))) {1_i32} else {external::op_add_int((var_x__index), (1_i32))};
            if (7_i32) <= (var_x__index) {break} else {()};
            var_x__index
        ...
        external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var__val_1))), (10_i32) as u8, (2_i32), (48_i32) as u8, (false), (false));
      } /*Append Iter_4*/;
      (var___work_1).push_str(&("]".to_string()));
  ...
  ;
  if (var_test_value) == ("a[02,04,06,08,10,12]b".to_string()) {()} else {panic!("{}", ({ //Formatted string_8: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"a[02,04,06,08,10,12]b\"".to_string()));
      var___work_2
