...
fn n_routine(stores: &mut Stores, mut var_a: i32) -> i32 { //block_1: integer
  ;
  if (4_i32) < (var_a) { //block_2: void
    return external::op_add_int((var_a), (1_i32));
  } /*block_2: void*/ else { //block_3: void
    return 1_i32;
  } /*block_3: void*/;
  2_i32
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    let _pre0 = n_routine(stores, 5_i32);
    let _pre1 = n_routine(stores, 2_i32);
    external::op_add_int((_pre0), (_pre1))
  } /*block_2: integer*/;
  ;
  if (var_test_value) == (7_i32) {()} else {panic!("{}", ({ //Formatted string_3: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 7".to_string()));
      var___work_1
