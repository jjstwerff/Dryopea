...
fn n_test(stores: &mut Stores) { //block_1: void
  let mut var___work_1: String = "".to_string();
  let mut var_test_value: i64 = { //block_2: long
    let mut var_b: i64 = 0_i64;
    { //For block_3: void
      let mut var_a__index: i64 = i64::MIN;
      loop { //For loop_4
        let mut var_a: i64 = { //Iter range_5: long
          var_a__index = if !(external::op_conv_bool_from_long((var_a__index))) {10_i64} else {external::op_add_long((var_a__index), (external::op_conv_long_from_int((1_i32))))};
          if (20_i64) < (var_a__index) {break} else {()};
          var_a__index
        } /*Iter range_5: long*/;
        { //block_6: void
          var_b = external::op_add_long((var_b), (var_a));
        } /*block_6: void*/;
      } /*For loop_4*/;
    } /*For block_3: void*/;
    var_b
  } /*block_2: long*/;
  if (var_test_value) == (165_i64) {()} else {panic!("{}", ({ //Formatted string_7: text["__work_1"]
      var___work_1 = "Test failed ".to_string();
      external::format_long(&mut (var___work_1), (var_test_value), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&(" != 165l".to_string()));
      var___work_1
