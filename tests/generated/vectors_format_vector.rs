...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    var__elm_1 = stores.record_new(&(var_v), (18_i32) as u16, (65535_i32) as u16);
    ...
    stores.record_finish(&(var_v), &(var__elm_1), (18_i32) as u16, (65535_i32) as u16);
    var__elm_1 = stores.record_new(&(var_v), (18_i32) as u16, (65535_i32) as u16);
    {let db = (var__elm_1); let _val = (8_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    stores.record_finish(&(var_v), &(var__elm_1), (18_i32) as u16, (65535_i32) as u16);
    ;
    let mut var__elm_2: DbRef = stores.record_new(&(var_v), (18_i32) as u16, (65535_i32) as u16);
    {let db = (var__elm_2); let _val = (16_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    stores.record_finish(&(var_v), &(var__elm_2), (18_i32) as u16, (65535_i32) as u16);
    ;
    { //Formatted string_3: text["__work_1"]
      var___work_1 = "".to_string();
      (var___work_1).push_str(&stores.rec(&(var_v), (18_i32) as u16));
      (var___work_1).push_str(&(" ".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((t_6vector_len(stores, var_v)))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&(" ".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int(({let db = (vector::get_vector(&(var_v), (4_i32) as u32, (2_i32), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&(" ".to_string()));
      (var___work_1).push_str(&("[".to_string()));
      ...
      loop { //Append Iter_4
        let mut var__val_5: i32 = { //Vector Index_5: integer
          let _pre1 = { //Iter range_6: integer
          ...
          let _pre0 = vector::get_vector(&(var_v), (4_i32) as u32, (_pre1), &stores.allocations);
          {let db = (_pre0); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }
        } /*Vector Index_5: integer*/;
        if (0_i32) < (var__count_4) {(var___work_1).push_str(&(",".to_string()))} else {()};
        var__count_4 = external::op_add_int((var__count_4), (1_i32));
        external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var__val_5))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      } /*Append Iter_4*/;
      (var___work_1).push_str(&("]".to_string()));
      (var___work_1).push_str(&(" ".to_string()));
      (var___work_1).push_str(&("[".to_string()));
      ...
      loop { //Append Iter_7
        let mut var__val_8: i32 = { //Vector Index_8: integer
          let _pre1 = { //Iter range_9: integer
        ...
        if (0_i32) < (var__count_7) {(var___work_1).push_str(&(",".to_string()))} else {()};
        var__count_7 = external::op_add_int((var__count_7), (1_i32));
        external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var__val_8))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      } /*Append Iter_7*/;
      (var___work_1).push_str(&("]".to_string()));
      (var___work_1).push_str(&(" ".to_string()));
      (var___work_1).push_str(&("[".to_string()));
      ...
      loop { //Append Iter_10
        let mut var__val_9: i32 = { //Iter For_11: integer
          let mut var_x: i32 = { //iter next_12: integer
            ...
            {let db = (vector::get_vector(&(var_v), (4_i32) as u32, (var_x__index), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }
        ...
        if (0_i32) < (var_x__count) {(var___work_1).push_str(&(",".to_string()))} else {()};
        var_x__count = external::op_add_int((var_x__count), (1_i32));
        external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var__val_9))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      } /*Append Iter_10*/;
      (var___work_1).push_str(&("]".to_string()));
      var___work_1
  ...
  ;
  if (var_test_value) == ("[1,2,4,8,16] 5 4 [2,4] [8,4,2] [2,4,8]".to_string()) {()} else {panic!("{}", ({ //Formatted string_15: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"[1,2,4,8,16] 5 4 [2,4] [8,4,2] [2,4,8]\"".to_string()));
      var___work_2
