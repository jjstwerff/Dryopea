  ...
  let mut var_test_value: i32 = { //block_2: integer
    ...
    { //For block_3: void
      ...
      loop { //For loop_4
        ...
        { //block_6: void
          let mut var_p: i32 = external::op_add_int((var_a), (1_i32));
          if (3_i32) < (var_a) { //block_7: void
            continue;
          } /*block_7: void*/ else {()};
          var_t = external::op_add_int((var_t), (var_p));
        } /*block_6: void*/;
      } /*For loop_4*/;
    } /*For block_3: void*/;
    var_t
  } /*block_2: integer*/;
  if (var_test_value) == (11_i32) {()} else {panic!("{}", ({ //Formatted string_8: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 11".to_string()));
      var___work_1
