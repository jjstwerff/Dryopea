...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    ...
    let mut var__elm_1: DbRef = stores.record_new(&(var_v), (20_i32) as u16, (65535_i32) as u16);
    ...
    stores.record_finish(&(var_v), &(var__elm_1), (20_i32) as u16, (65535_i32) as u16);
    var__elm_1 = stores.record_new(&(var_v), (20_i32) as u16, (65535_i32) as u16);
    {let db = (var__elm_1); let _val = (12_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    {let db = (var__elm_1); let _val = (13_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
    stores.record_finish(&(var_v), &(var__elm_1), (20_i32) as u16, (65535_i32) as u16);
    var__elm_1 = stores.record_new(&(var_v), (20_i32) as u16, (65535_i32) as u16);
    {let db = (var__elm_1); let _val = (4_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    {let db = (var__elm_1); let _val = (5_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
    stores.record_finish(&(var_v), &(var__elm_1), (20_i32) as u16, (65535_i32) as u16);
    ;
    {let db = (vector::get_vector(&(var_v), (8_i32) as u32, (2_i32), &stores.allocations)); let _val = (6_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
    ;
    let mut var_e: DbRef = vector::get_vector(&(var_v), (8_i32) as u32, (0_i32), &stores.allocations);
    ;
    let mut var_t: i32 = 0_i32;
    ;
    { //For block_3: void
      let mut var__vector_2: DbRef = var_v;
      let mut var_el__index: i32 = -1_i32;
      loop { //For loop_4
        let mut var_el: DbRef = { //iter next_5: ref(Elm)
          var_el__index = external::op_add_int((var_el__index), (1_i32));
          vector::get_vector(&(var__vector_2), (8_i32) as u32, (var_el__index), &stores.allocations)
        } /*iter next_5: ref(Elm)*/;
        if !((var_el).rec != 0) { //break_6: void
          break;
        } /*break_6: void*/ else {()};
        { //block_7: void
          var_t = external::op_add_int((var_t), (external::op_add_int(({let db = (var_el); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }), ({let db = (var_el); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (4_i32) as u32)} }))));
        } /*block_7: void*/;
      } /*For loop_4*/;
    } /*For block_3: void*/;
    ;
    if (var_t) == (38_i32) {()} else {panic!("{}", ({ //Formatted string_8: text["__work_1"]
        var___work_1 = "Incorrect sum ".to_string();
        external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var_t))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
        var___work_1
      } /*Formatted string_8: text["__work_1"]*/));};
    ;
    external::op_add_int((external::op_add_int(({let db = (var_e); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (4_i32) as u32)} }), ({let db = (vector::get_vector(&(var_v), (8_i32) as u32, (1_i32), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }))), ({let db = (vector::get_vector(&(var_v), (8_i32) as u32, (2_i32), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (4_i32) as u32)} }))
  } /*block_2: integer*/;
  ;
  if (var_test_value) == (20_i32) {()} else {panic!("{}", ({ //Formatted string_9: text["__work_2"]
      ...
      (var___work_2).push_str(&(" != 20".to_string()));
      var___work_2
