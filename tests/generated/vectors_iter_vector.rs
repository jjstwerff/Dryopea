...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    ...
    ;
    { //For block_3: void
      let mut var__index_2: i32 = i32::MIN;
      loop { //For loop_4
        let mut var_e: i32 = { //Vector Index_5: integer
          let _pre1 = { //Iter range_6: integer
            var__index_2 = if !(external::op_conv_bool_from_int((var__index_2))) {1_i32} else {external::op_add_int((var__index_2), (1_i32))};
            if (3_i32) <= (var__index_2) {break} else {()};
            var__index_2
        ...
        { //block_7: void
          ;
          var_c = external::op_add_int((external::op_mul_int((var_c), (10_i32))), (var_e));
        } /*block_7: void*/;
      } /*For loop_4*/;
    } /*For block_3: void*/;
    ;
    { //For block_8: void
      ...
      loop { //For loop_9
        let mut var_e: i32 = { //Vector Index_10: integer
          let _pre1 = { //Iter range_11: integer
            var__index_3 = if !(external::op_conv_bool_from_int((var__index_3))) {2_i32} else {external::op_add_int((var__index_3), (1_i32))};
            if (vector::length_vector(&(var_v), &stores.allocations) as i32) <= (var__index_3) {break} else {()};
            var__index_3
          } /*Iter range_11: integer*/;
          let _pre0 = vector::get_vector(&(var_v), (4_i32) as u32, (_pre1), &stores.allocations);
          {let db = (_pre0); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }
        } /*Vector Index_10: integer*/;
        { //block_12: void
          ;
          var_c = external::op_add_int((external::op_mul_int((var_c), (10_i32))), (var_e));
        } /*block_12: void*/;
    ...
    ;
    if !(external::op_conv_bool_from_int(({let db = (vector::get_vector(&(var_v), (4_i32) as u32, (4_i32), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }))) {()} else {panic!("{}", ("Incorrect reading outside vector bounds".to_string()));};
    ;
    var_c
  } /*block_2: integer*/;
  ;
  if (var_test_value) == (2448_i32) {()} else {panic!("{}", ({ //Formatted string_13: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 2448".to_string()));
      var___work_1
    } /*Formatted string_13: text["__work_1"]*/));};
  drop((var___ref_1));
  {};
} /*block_1: void*/
