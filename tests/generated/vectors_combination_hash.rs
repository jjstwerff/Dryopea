...
fn n_fill(stores: &mut Stores, mut var_c: DbRef) { //block_1: void
  let mut var__elm_1: DbRef = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_1); let s_val = ("One".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_1); let _val = (1_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_1), (19_i32) as u16, (0_i32) as u16);
  var__elm_1 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_1); let s_val = ("Two".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_1); let _val = (2_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_1), (19_i32) as u16, (0_i32) as u16);
  let mut var__elm_2: DbRef = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Three".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (3_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Four".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (4_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Five".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (5_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Six".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (6_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Seven".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (7_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Eight".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (8_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Nine".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (9_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Ten".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (10_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Eleven".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (11_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Twelve".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (12_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
  var__elm_2 = stores.record_new(&(var_c), (19_i32) as u16, (0_i32) as u16);
  {let db = (var__elm_2); let s_val = ("Thirteen".to_string()).to_string(); let store = stores.store_mut(&db); let s_pos = store.set_str(&s_val); store.set_int(db.rec, db.pos + (0_i32) as u32, s_pos as i32);};
  {let db = (var__elm_2); let _val = (13_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
  stores.record_finish(&(var_c), &(var__elm_2), (19_i32) as u16, (0_i32) as u16);
} /*block_1: void*/
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    ...
    (var_c) = stores.alloc_record((19_i32) as u16);
    {let db = (var_c); let _val = (0_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    {let db = (var_c); let _val = (0_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (4_i32) as u32, _val);};
    n_fill(stores, var_c);
    if !((stores.find_str(&(DbRef {store_nr: (var_c).store_nr, rec: (var_c).rec, pos: (var_c).pos + (4_i32) as u32}), (21_i32) as u16, ("None".to_string()).as_str())).rec != 0) {()} else {panic!("{}", ("No element".to_string()));};
    let mut var_add: i32 = 0_i32;
    { //For block_3: void
      let mut var__vector_1: DbRef = DbRef {store_nr: (var_c).store_nr, rec: (var_c).rec, pos: (var_c).pos + (0_i32) as u32};
      ...
      loop { //For loop_4
        let mut var_v: DbRef = { //iter next_5: ref(Count)
          ...
          stores.get_ref(&vector::get_vector(&(var__vector_1), 4, (var_v__index), &stores.allocations), 0)
        } /*iter next_5: ref(Count)*/;
        if !((var_v).rec != 0) { //break_6: void
          break;
        } /*break_6: void*/ else {()};
        { //block_7: void
          var_add = external::op_add_int((var_add), ({let db = (var_v); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (4_i32) as u32)} }));
        } /*block_7: void*/;
      } /*For loop_4*/;
    } /*For block_3: void*/;
    if (var_add) == (91_i32) {()} else {panic!("{}", ("Incorrect sum".to_string()));};
    let _ret = external::op_add_int(({let db = (stores.find_str(&(DbRef {store_nr: (var_c).store_nr, rec: (var_c).rec, pos: (var_c).pos + (4_i32) as u32}), (21_i32) as u16, ("Five".to_string()).as_str())); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (4_i32) as u32)} }), ({let db = (stores.find_str(&(DbRef {store_nr: (var_c).store_nr, rec: (var_c).rec, pos: (var_c).pos + (4_i32) as u32}), (21_i32) as u16, ("Seven".to_string()).as_str())); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (4_i32) as u32)} }));
    drop((var_c));
    _ret
  } /*block_2: integer*/;
  if (var_test_value) == (12_i32) {()} else {panic!("{}", ({ //Formatted string_8: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 12".to_string()));
      var___work_1
