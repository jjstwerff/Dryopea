...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    {let db = (var__elm_1); let _val = i32::from((1_u8)); stores.store_mut(&db).set_byte(db.rec, db.pos + (0_i32) as u32, 0, _val);};
    stores.record_finish(&(var_v), &(var__elm_1), (20_i32) as u16, (65535_i32) as u16);
    let mut var__elm_2: DbRef = stores.record_new(&(var_v), (20_i32) as u16, (65535_i32) as u16);
    {let db = (var__elm_2); let _val = i32::from((2_u8)); stores.store_mut(&db).set_byte(db.rec, db.pos + (0_i32) as u32, 0, _val);};
    stores.record_finish(&(var_v), &(var__elm_2), (20_i32) as u16, (65535_i32) as u16);
    let _pre0 = { //Vector_3: vector<Val>
      ...
      let mut var__elm_4: DbRef = stores.record_new(&(var__vec_3), (20_i32) as u16, (65535_i32) as u16);
      {let db = (var__elm_4); let _val = i32::from((3_u8)); stores.store_mut(&db).set_byte(db.rec, db.pos + (0_i32) as u32, 0, _val);};
      stores.record_finish(&(var__vec_3), &(var__elm_4), (20_i32) as u16, (65535_i32) as u16);
      var__vec_3
    } /*Vector_3: vector<Val>*/;
    stores.vector_add(&(var_v), &(_pre0), (18_i32) as u16);;
    let _pre1 = { //Vector_4: vector<Val>
      ...
      let mut var__elm_6: DbRef = stores.record_new(&(var__vec_5), (20_i32) as u16, (65535_i32) as u16);
      {let db = (var__elm_6); let _val = i32::from((1_u8)); stores.store_mut(&db).set_byte(db.rec, db.pos + (0_i32) as u32, 0, _val);};
      stores.record_finish(&(var__vec_5), &(var__elm_6), (20_i32) as u16, (65535_i32) as u16);
      var__vec_5
    } /*Vector_4: vector<Val>*/;
    stores.vector_add(&(var_v), &(_pre1), (18_i32) as u16);;
    { //Formatted string_5: text["__work_1"]
      var___work_1 = "".to_string();
      (var___work_1).push_str(&stores.rec(&(var_v), (20_i32) as u16));
      var___work_1
    } /*Formatted string_5: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("[A,A,B,C,A]".to_string()) {()} else {panic!("{}", ({ //Formatted string_6: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"[A,A,B,C,A]\"".to_string()));
      var___work_2
