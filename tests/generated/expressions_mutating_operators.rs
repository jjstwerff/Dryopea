...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    let mut var_a: i32 = 12_i32;
    var_a = external::op_min_int((var_a), (6_i32));
    var_a = external::op_mul_int((var_a), (3_i32));
    var_a = external::op_div_int((var_a), (2_i32));
    var_a = external::op_add_int((var_a), (1_i32));
    var_a
  } /*block_2: integer*/;
