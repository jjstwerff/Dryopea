...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    { //Formatted string_3: text["__work_1"]
      ...
      external::format_text(&mut (var___work_1), &(external::sub_text(&(var_txt), (2_i32), (external::op_min_single_int((1_i32)))).to_string()), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_1).push_str(&("b".to_string()));
      {};
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  if (var_test_value) == ("a😊🙃4b".to_string()) {()} else {panic!("{}", ({ //Formatted string_4: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"a😊🙃4b\"".to_string()));
      var___work_2
