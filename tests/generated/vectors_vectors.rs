...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    ...
    stores.record_finish(&(var_v), &(var__elm_1), (18_i32) as u16, (65535_i32) as u16);
    var__elm_1 = stores.record_new(&(var_v), (18_i32) as u16, (65535_i32) as u16);
    {let db = (var__elm_1); let _val = (external::op_add_int((1_i32), (2_i32))); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    stores.record_finish(&(var_v), &(var__elm_1), (18_i32) as u16, (65535_i32) as u16);
    ...
    { //For block_3: void
      let mut var__vector_3: DbRef = var_v;
      let mut var_e__index: i32 = -1_i32;
      loop { //For loop_4
        let mut var_e: i32 = { //iter next_5: integer
          var_e__index = external::op_add_int((var_e__index), (1_i32));
          {let db = (vector::get_vector(&(var__vector_3), (4_i32) as u32, (var_e__index), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }
        } /*iter next_5: integer*/;
        if !(external::op_conv_bool_from_int((var_e))) { //break_6: void
          break;
        } /*break_6: void*/ else {()};
        { //block_7: void
          var_t = external::op_add_int((var_t), (var_e));
        } /*block_7: void*/;
      } /*For loop_4*/;
    } /*For block_3: void*/;
    {let db = (vector::get_vector(&(var_v), (4_i32) as u32, (external::op_add_int((1_i32), (2_i32))), &stores.allocations)); let _val = (5_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    external::op_add_int((external::op_add_int((external::op_add_int((var_t), ({let db = (vector::get_vector(&(var_v), (4_i32) as u32, (0_i32), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }))), ({let db = (vector::get_vector(&(var_v), (4_i32) as u32, (external::op_min_single_int((1_i32))), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }))), (t_6vector_len(stores, var_v)))
  } /*block_2: integer*/;
  if (var_test_value) == (20_i32) {()} else {panic!("{}", ({ //Formatted string_8: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 20".to_string()));
      var___work_1
