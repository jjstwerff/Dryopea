...
fn n_format(stores: &mut Stores, mut var_a: i32, mut var___work_1: DbRef) -> String {
  todo!("RefVar parameters are not yet supported in generated code")
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    { //Add text_3: text["__work_3"]
      (var___work_3).clear();;
      let _pre0 = { //default ref_4: ref(reference)["__work_1"]
        todo!()
      } /*default ref_4: ref(reference)["__work_1"]*/;
      (var___work_3).push_str(&(n_format(stores, 123_i32, _pre0)));
      let _pre1 = { //default ref_5: ref(reference)["__work_2"]
        todo!()
      } /*default ref_5: ref(reference)["__work_2"]*/;
      (var___work_3).push_str(&(n_format(stores, i32::MIN, _pre1)));
      var___work_3
    } /*Add text_3: text["__work_3"]*/.to_string()
  } /*block_2: text["__work_3"]*/;
  if (var_test_value) == ("a123banullb".to_string()) {()} else {panic!("{}", ({ //Formatted string_6: text["__work_4"]
      var___work_4 = "Test failed ".to_string();
      external::format_text(&mut (var___work_4), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_4).push_str(&(" != \"a123banullb\"".to_string()));
      var___work_4
