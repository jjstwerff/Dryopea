...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    let mut var_points: DbRef = DbRef {store_nr: (var___ref_1).store_nr, rec: (var___ref_1).rec, pos: (var___ref_1).pos + (0_i32) as u32};
    {let db = (var___ref_1); let _val = (0_i32); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
    let mut var__elm_1: DbRef = stores.record_new(&(var_points), (20_i32) as u16, (65535_i32) as u16);
    {let db = (var__elm_1); let _val = (128_i32); stores.store_mut(&db).set_byte(db.rec, db.pos + (0_i32) as u32, i32::from((0_i32)), _val);};
    {let db = (var__elm_1); let _val = (128_i32); stores.store_mut(&db).set_byte(db.rec, db.pos + (2_i32) as u32, i32::from((0_i32)), _val);};
    {let db = (var__elm_1); let _val = (0_i32); stores.store_mut(&db).set_byte(db.rec, db.pos + (1_i32) as u32, i32::from((0_i32)), _val);};
    stores.record_finish(&(var_points), &(var__elm_1), (20_i32) as u16, (65535_i32) as u16);
    var__elm_1 = stores.record_new(&(var_points), (20_i32) as u16, (65535_i32) as u16);
    {let db = (var__elm_1); let _val = (255_i32); stores.store_mut(&db).set_byte(db.rec, db.pos + (2_i32) as u32, i32::from((0_i32)), _val);};
    {let db = (var__elm_1); let _val = (0_i32); stores.store_mut(&db).set_byte(db.rec, db.pos + (0_i32) as u32, i32::from((0_i32)), _val);};
    {let db = (var__elm_1); let _val = (0_i32); stores.store_mut(&db).set_byte(db.rec, db.pos + (1_i32) as u32, i32::from((0_i32)), _val);};
    stores.record_finish(&(var_points), &(var__elm_1), (20_i32) as u16, (65535_i32) as u16);
    ;
    { //Formatted string_3: text["__work_1"]
      var___work_1 = "size:".to_string();
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((3_i32))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&(" purple:".to_string()));
      (var___work_1).push_str(&stores.rec(&(vector::get_vector(&(var_points), (3_i32) as u32, (0_i32), &stores.allocations)), (18_i32) as u16));
      (var___work_1).push_str(&(" value:".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((t_5Point_value(stores, vector::get_vector(&(var_points), (3_i32) as u32, (0_i32), &stores.allocations))))), (16_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&(" blue:".to_string()));
      (var___work_1).push_str(&stores.rec(&(vector::get_vector(&(var_points), (3_i32) as u32, (1_i32), &stores.allocations)), (18_i32) as u16));
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("size:3 purple:{r:128,g:0,b:128} value:800080 blue:{r:0,g:0,b:255}".to_string()) {()} else {panic!("{}", ({ //Formatted string_4: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"size:3 purple:{r:128,g:0,b:128} value:800080 blue:{r:0,g:0,b:255}\"".to_string()));
      var___work_2
