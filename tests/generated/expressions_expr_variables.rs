...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    let mut var_a: i32 = 1_i32;
    let mut var_b: i32 = 12_i32;
    external::op_add_int((external::op_add_int((0_i32), (var_b))), (var_a))
  } /*block_2: integer*/;
  ;
  if (var_test_value) == (13_i32) {()} else {panic!("{}", ({ //Formatted string_3: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 13".to_string()));
      var___work_1
