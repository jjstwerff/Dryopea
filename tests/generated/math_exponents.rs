...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: f64 = { //block_2: float
    t_5float_log(stores, (4_f64).powf((external::op_conv_float_from_int((5_i32)))), external::op_conv_float_from_int((2_i32)))
  } /*block_2: float*/;
  ;
  if ((var_test_value) - (external::op_conv_float_from_int((10_i32)))).abs() < 0.000_000_001f64 {()} else {panic!("{}", ({ //Formatted string_3: text["__work_1"]
