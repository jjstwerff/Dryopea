  ...
  let mut var_test_value = String::new();
    ...
    { //For block_3: void
      ...
      loop { //For loop_4
        ...
        { //block_6: void
          let mut var__elm_1: DbRef = stores.record_new(&(var_a), (18_i32) as u16, (65535_i32) as u16);
          {let db = (var__elm_1); let _val = (external::op_mul_int((var_v), (10_i32))); stores.store_mut(&db).set_int(db.rec, db.pos + (0_i32) as u32, _val);};
          stores.record_finish(&(var_a), &(var__elm_1), (18_i32) as u16, (65535_i32) as u16);
        } /*block_6: void*/;
      } /*For loop_4*/;
    } /*For block_3: void*/;
    ;
    ...
    { //For block_7: void
      ...
      loop { //For loop_8
        let mut var_elm: i32 = { //iter next_9: integer
          ...
          {let db = (vector::get_vector(&(var__vector_2), (4_i32) as u32, (var_elm__index), &stores.allocations)); if db.rec == 0 { i32::MIN } else { stores.store(&db).get_int(db.rec, db.pos + (0_i32) as u32)} }
        } /*iter next_9: integer*/;
    ...
    { //Formatted string_12: text["__work_1"]
      var___work_1 = "".to_string();
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((var_sum))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      var___work_1
    } /*Formatted string_12: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("798000".to_string()) {()} else {panic!("{}", ({ //Formatted string_13: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"798000\"".to_string()));
      var___work_2
