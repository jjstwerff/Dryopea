...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    let mut var_txt: String = "12😊🙃45".to_string();
    { //Formatted string_3: text["__work_1"]
      var___work_1 = "a".to_string();
      (var___work_1).push_str(&("[".to_string()));
      let mut var_c__index: i32 = 0_i32;
      let mut var_c__count: i32 = 0_i32;
      loop { //Append Iter_4
        let mut var__val_1 = String::new();
          var__val_1 = { //Iter For_5: text["__work_2"]
          let mut var_c: char = { //for text next_6: character
            let mut var__for_result_2: char = external::text_character(&(external::sub_text(&(var_txt), (2_i32), (external::op_min_single_int((1_i32)))).to_string()), (var_c__index));
            var_c__index = external::op_add_int((var_c__index), (((var__for_result_2).len_utf8() as i32)));
            var__for_result_2
          } /*for text next_6: character*/;
          if !(external::op_conv_bool_from_character((var_c))) { //break_7: void
            {};
            break;
          } /*break_7: void*/ else {()};
          { //block_8: text["__work_2"]
            { //Formatted string_9: text["__work_2"]
              var___work_2 = "".to_string();
              external::format_long(&mut (var___work_2), (external::op_conv_long_from_int((var_c__index))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
              (var___work_2).push_str(&(":".to_string()));
              if let Some(c) = char::from_u32((var_c) as u32) { (var___work_2).push(c); };
              var___work_2
            } /*Formatted string_9: text["__work_2"]*/.to_string()
          } /*block_8: text["__work_2"]*/.to_string()
        } /*Iter For_5: text["__work_2"]*/;
        if (0_i32) < (var_c__count) {(var___work_1).push_str(&(",".to_string()))} else {()};
        var_c__count = external::op_add_int((var_c__count), (1_i32));
        external::format_text(&mut (var___work_1), &(var__val_1), (0_i32), (-1_i32) as i8, (32_i32) as u8);
        {};
      } /*Append Iter_4*/;
      (var___work_1).push_str(&("]".to_string()));
      (var___work_1).push_str(&("b".to_string()));
      {};
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  if (var_test_value) == ("a[4:😊,8:🙃,9:4]b".to_string()) {()} else {panic!("{}", ({ //Formatted string_10: text["__work_3"]
      var___work_3 = "Test failed ".to_string();
      external::format_text(&mut (var___work_3), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_3).push_str(&(" != \"a[4:😊,8:🙃,9:4]b\"".to_string()));
      var___work_3
    } /*Formatted string_10: text["__work_3"]*/));};
  {};
  {};
  {};
  {};
