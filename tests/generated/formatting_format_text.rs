...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    let mut var_vr: String = "abc".to_string();
    { //Formatted string_3: text["__work_1"]
      var___work_1 = "1".to_string();
      external::format_text(&mut (var___work_1), &(var_vr), (external::op_add_int((2_i32), (3_i32))), (-1_i32) as i8, (32_i32) as u8);
      (var___work_1).push_str(&("2".to_string()));
      external::format_text(&mut (var___work_1), &(var_vr), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_1).push_str(&("3".to_string()));
      external::format_text(&mut (var___work_1), &(var_vr), (6_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_1).push_str(&("4".to_string()));
      external::format_text(&mut (var___work_1), &(var_vr), (7_i32), (1_i32) as i8, (32_i32) as u8);
      {};
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  if (var_test_value) == ("1abc  2abc3abc   4    abc".to_string()) {()} else {panic!("{}", ({ //Formatted string_4: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"1abc  2abc3abc   4    abc\"".to_string()));
      var___work_2
