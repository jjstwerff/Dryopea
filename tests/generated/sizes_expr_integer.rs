...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    ...
    external::op_add_int((external::op_add_int((4_i32), (4_i32))), (external::op_mul_int((10_i32), (4_i32))))
  } /*block_2: integer*/;
  ;
  if (var_test_value) == (48_i32) {()} else {panic!("{}", ({ //Formatted string_3: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 48".to_string()));
      var___work_1
