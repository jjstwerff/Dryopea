...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    { //For block_3: void
      ...
      loop { //For loop_4
        let mut var_v: i32 = { //Iter range_5: integer
          ...
          if (4_i32) <= (var_v__index) {break} else {()};
          var_v__index
    ...
    { //Formatted string_7: text["__work_1"]
      ...
      var___work_1
    } /*Formatted string_7: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("[10,20,30]".to_string()) {()} else {panic!("{}", ({ //Formatted string_8: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"[10,20,30]\"".to_string()));
      var___work_2
