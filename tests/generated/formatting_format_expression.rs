...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    { //Formatted string_3: text["__work_1"]
      var___work_1 = "ab".to_string();
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((external::op_add_int((external::op_add_int((1_i32), (2_i32))), (32_i32))))), (16_i32) as u8, (0_i32), (32_i32) as u8, (false), (true));
      (var___work_1).push_str(&("c".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((12_i32))), (8_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&("d".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((391_i32))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&("e".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((12_i32))), (10_i32) as u8, (4_i32), (32_i32) as u8, (true), (false));
      (var___work_1).push_str(&("f".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((1_i32))), (10_i32) as u8, (3_i32), (48_i32) as u8, (false), (false));
      (var___work_1).push_str(&("g".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((42_i32))), (2_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&("h".to_string()));
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("ab0x23c14d391e +12f001g101010h".to_string()) {()} else {panic!("{}", ({ //Formatted string_4: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"ab0x23c14d391e +12f001g101010h\"".to_string()));
      var___work_2
