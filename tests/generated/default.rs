...
fn init(db: &mut KnownTypes) {
    ...
    db.field(s, "vector".to_string(), db.vector(13), 65535);
}
...
fn _tp_File_files(stores: &mut Stores, var_0: DbRef, var_1: DbRef) -> DbRef {
  ...
  var_result = DbRef {store_nr: (var___ref_1).store_nr, rec: (var___ref_1).rec, pos: (var___ref_1).pos + u32::from((65535_i32))};
