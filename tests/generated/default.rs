...

{
  ...
  d.returned = Type::Enum(enumerate);
  d.size = 1;
}
...

{
  ...
  d.returned = Type::Reference(reference);
  d.size = 4;
}
...

{
  ...
  d.returned = Type::Reference(hash);
  d.size = 4;
}
...

{
  ...
  d.returned = Type::Reference(index);
  d.size = 4;
}
...

{
  ...
  d.returned = Type::Reference(radix);
  d.size = 4;
}
