...
fn _tp_File_lines(stores: &mut Stores, var_0: DbRef, var_1: DbRef) -> DbRef { //block_1: vector<text["c"]>["l"]
  var___ref_3 = Null;
  var___ref_2 = Null;
  var___ref_1 = Null;
...
".to_string()) { //block_7: void
        ...
        } //block_7: void else {if (var_p) < (0_i32) { //block_8: void
            var_p = var_ch#index
          } //block_8: void else {Null}}
      } //block_6: void;
      OpFreeText(stores, var_ch);
    } //For loop_4
  } //For block_3: void;
  if (var_p) > (0_i32) { //block_9: void
