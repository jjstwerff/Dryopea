...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    { //Formatted string_3: text["__work_1"]
      ...
      external::format_long(&mut (var___work_1), (external::op_add_long((1_i64), (external::op_conv_long_from_int((1_i32))))), (10_i32) as u8, (4_i32), (32_i32) as u8, (true), (false));
      (var___work_1).push_str(&("b".to_string()));
      external::format_long(&mut (var___work_1), (external::op_conv_long_from_int((external::op_cast_int_from_long((12_i64))))), (10_i32) as u8, (0_i32), (32_i32) as u8, (false), (false));
      (var___work_1).push_str(&("c ".to_string()));
      external::format_text(&mut (var___work_1), &(if ((external::op_conv_long_from_int((8_i32))) <= (external::op_mul_long((2_i64), (external::op_rem_long((4_i64), (6_i64)))))) {"true"} else {"false"}), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_1).push_str(&(" d".to_string()));
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("a  +2b12c true d".to_string()) {()} else {panic!("{}", ({ //Formatted string_4: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"a  +2b12c true d\"".to_string()));
      var___work_2
