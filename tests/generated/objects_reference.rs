...
fn n_add(stores: &mut Stores, mut var_a: DbRef, mut var_b: i32, mut var_c: i32) {
  todo!("RefVar parameters are not yet supported in generated code")
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    let mut var_v: i32 = 1_i32;
    n_add(stores, todo!(), 2_i32, 0_i32);
    n_add(stores, todo!(), 4_i32, 1_i32);
    var_v
  } /*block_2: integer*/;
  if (var_test_value) == (8_i32) {()} else {panic!("{}", ({ //Formatted string_3: text["__work_1"]
      ...
      (var___work_1).push_str(&(" != 8".to_string()));
      var___work_1
