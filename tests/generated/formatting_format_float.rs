...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = String::new();
    ...
    { //Formatted string_3: text["__work_1"]
      ...
      external::format_float(&mut (var___work_1), (1.2_f64), (4_i32), (2_i32));
      (var___work_1).push_str(&("b".to_string()));
      external::format_float(&mut (var___work_1), (1.34_f64), (0_i32), (0_i32));
      (var___work_1).push_str(&("c".to_string()));
      external::format_float(&mut (var___work_1), (1.4_f64), (5_i32), (0_i32));
      (var___work_1).push_str(&("d".to_string()));
      external::format_float(&mut (var___work_1), (334.1_f64), (0_i32), (2_i32));
      (var___work_1).push_str(&("e".to_string()));
      var___work_1
    } /*Formatted string_3: text["__work_1"]*/.to_string()
  } /*block_2: text["__work_1"]*/;
  ;
  if (var_test_value) == ("a1.20b1.34c  1.4d334.10e".to_string()) {()} else {panic!("{}", ({ //Formatted string_4: text["__work_2"]
      var___work_2 = "Test failed ".to_string();
      external::format_text(&mut (var___work_2), &(var_test_value), (0_i32), (-1_i32) as i8, (32_i32) as u8);
      (var___work_2).push_str(&(" != \"a1.20b1.34c  1.4d334.10e\"".to_string()));
      var___work_2
