...
fn n_parse(stores: &mut Stores, mut var_s: String) -> i32 { //block_1: integer
  { //For block_2: void
    ...
    loop { //For loop_3
      ...
      { //block_5: void
        let mut var_l: char = external::text_character(&(var_s), (var_t));
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: i32 = { //block_2: integer
    n_parse(stores, "if_cond ".to_string().to_string())
  } /*block_2: integer*/;
