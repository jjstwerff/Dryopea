...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value: bool = { //block_2: boolean
    (if (if (1_i32) == i32::MIN { 255 } else { (1_i32) as u8 }) == 255 { i32::MIN } else { i32::from((if (1_i32) == i32::MIN { 255 } else { (1_i32) as u8 })) }) < (if (if (3_i32) == i32::MIN { 255 } else { (3_i32) as u8 }) == 255 { i32::MIN } else { i32::from((if (3_i32) == i32::MIN { 255 } else { (3_i32) as u8 })) })
  } /*block_2: boolean*/;
