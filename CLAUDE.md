...
| **No wall trigger, no ordering, no tower repair, no beacons and no scramble** — and ⚠ **tower repair is now the named blocker on everything else** | [plans/ROADMAP.md](plans/ROADMAP.md) § Tower mechanics depth |
